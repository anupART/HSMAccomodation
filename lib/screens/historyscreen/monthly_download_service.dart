...
class MonthlyDownloadService {
  ...
  Future<void> monthlyExcel(BuildContext context, int month, int year) async {
    try {
      ...
      final response = await http.post(
        Uri.parse('https://beds-accomodation.vercel.app/api/getAllBookingExcel'),
      ...
      if (response.statusCode == 200) {
        ...
        final taskId = await FlutterDownloader.enqueue(
          ...
          fileName:  'BookingHistory_$month$year.xlsx',
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text("Downloaded file 'BookingHistory_$month$year.xlsx'"),
